...
import { Search, ListFilter, Dog, Cat } from "lucide-react";
  ...
  return (
    <div className="mb-8 space-y-4">
      <div className="relative">
        ...
        <Input placeholder="Search by criteria" className="pl-10 h-12 rounded-full" />
      ...
      <div className="flex items-center gap-2 overflow-x-auto pb-2">
        ...
        <Button variant="outline" className="rounded-full">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-2 h-5 w-5"><path d="M12 22v-2"/><path d="M8.5 15a4.5 4.5 0 0 0 7 0"/><path d="M12 11V2"/><path d="m15 5-3-3-3 3"/></svg>
          Electricity
        </Button>
      </div>
    </div>
