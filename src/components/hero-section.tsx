...
export function HeroSection() {
  return (
    <section className="relative flex h-[50vh] w-full items-center justify-center bg-background pb-24 pt-12">
      ...
      <div className="container z-10 mx-auto flex flex-col items-center px-4 pt-16 text-center">
        ...
        >
          <span className="text-green-500">🟢</span> Raise Your Voice.
        </h1>
